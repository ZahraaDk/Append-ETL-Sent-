...
CREATE OR REPLACE FUNCTION target_schema.get_rental_duration(rental_date TIMESTAMP, return_date TIMESTAMP)
RETURNS INTEGER AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION target_schema.get_film_category(film_id INTEGER)
RETURNS TEXT AS $$
DECLARE 
    category_name TEXT;
BEGIN
